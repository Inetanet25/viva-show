                    ...
                    <div className='picture-and-text'>
                        ...
                        <div className='text-right-of-picture-container'>
                            <div className='text-right-of-picture'>
                                ...
                                <div className='text'>
                                    Event production VIVA-show призван создать уникальное мероприятие, которое позволит
                                    вам
                                    почувствовать себя кинозвездой. Мы подготовим для вас оригинальный сценарий по
                                    мотивам
                                    известных
                                    кинокартин и отправимся в увлекательное путешествие под названием «Кино».<br/><br/>
                                    Над
