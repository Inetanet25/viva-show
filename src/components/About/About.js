    ...
    return (<div className='about'>
            <div className='picture-and-text-container'>
                <div className='picture-and-text'>
                    ...
                    <div className='text-right-of-picture-container'>
                        <div className='text-right-of-picture'>
                            <div className='upper-text'>
                                <h1>Мы ценим качество и гарантируем результат, которым вы останетесь довольны</h1>
                            </div>
                            <div className='text'>
                                Event production VIVA-show призван создать уникальное мероприятие, которое позволит вам
                                почувствовать себя кинозвездой. Мы подготовим для вас оригинальный сценарий по мотивам
                                известных
                                кинокартин и отправимся в увлекательное путешествие под названием «Кино».
                            </div>
                            <div className='text'>
                                Над
                            ...
                            <div className='card'>
                                <div className='card-container'>
                                    ...
                                    <div className='card-container-text'>
                                        Своей задачей мы видим создание уникального продукта, который существует вне
                                        времени.
                                    </div>
                                </div>
                            </div>
